...
import { DollarSign, Handshake, GraduationCap, Users, Heart, Building2, ArrowRight } from 'lucide-react';
...
const GetInvolvedSection = ({
  ...
  return <section id="get-involved" className="py-20 bg-gradient-to-b from-primary/5 to-accent/5">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-20">
            {opportunities.map((opportunity, index) => <Card key={index} className="border-border hover:shadow-card transition-all duration-300 h-full">
          ...
          <div className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {fundingLevels.map((level, index) => <Card key={index} className="border-border hover:shadow-card transition-all duration-300">
                  <CardHeader className="text-center">
                  ...
                  <CardContent>
                    <ul className="space-y-2">
                      {level.includes.map((item, idx) => <li key={idx} className="flex items-center gap-2 text-sm text-foreground">
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {partners.map((partner, index) => <Card key={index} className="border-border hover:shadow-card transition-all duration-300 text-center">
                  <CardHeader>
